...
define("ROOT_URL", "https://freakphone.net/oekaki/");

//掲示板のタイトル（<title>とTOP）
//Board title (appears in <title> and site header)
define("TITLE", "Drawing Room");
...
// Absolute path is OK.
define("HOME", "https://freakphone.net");
